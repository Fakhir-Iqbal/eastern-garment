  ...
  return (
    <>
      <div className='max-w-7xl mx-auto' >
        <Image height={1000} width={1000} className='h-full w-full rounded-lg brightness-50 contrast-125' src='/expertiesImages/history.jpg' />
      ...
      <div>
        <h1 className='text-center text-5xl text-blue-950 font-bold pt-5' >Our Expertise</h1>
